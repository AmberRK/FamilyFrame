...
<!-- Navigation Bar -->
	<div class="navbar">
		...
		<a href="#editor">Tree Editor</a>
		<a href="#editor">UI Settings</a>
...
<!-- Placeholder Body Text/div -->
	<div class = "mainbody">
		...
		<p>The navigation bar on top allows for easy navigation between what we may decide to implement into the site
	</div>
...
.mainbody h2 {border-style: double;
  border-radius: 25px;}
